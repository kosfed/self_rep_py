...
class S(BaseHTTPRequestHandler):
  ...
  def do_GET(self):
        ...
        try:
            ...
            self.wfile.write(bytes('Sorry, but server can\'t load UI form.', 'utf8'))
        return
        ...
        try:
            ...
            if not r_exists:
                ...
                if repo:
                    ...
                    msg = ('Repository have been created and files have been uploaded into it.', 'success')
                else:
                    msg = ('Can\'t create repository in your account.', 'danger')
            else:
                msg = ('You already have repository with such application name. Please change name.', 'warning')
